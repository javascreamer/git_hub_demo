...
<html>
<head>
<title>I-wear A Ecommerce Category Flat Bootstarp Resposive Website Template | About :: w3layouts</title>
			...
			<div class="container">
					<div class="header-top-in">
						...
						<ul class=" support-right">
							<li><a href="account"><i class="glyphicon glyphicon-user" class="men"> </i>Login</a></li>
