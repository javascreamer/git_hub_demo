			...
			<div class="container">
					<div class="header-top-in">
						...
						<ul class=" support-right">
							<li><a href="userLogin"><i class="glyphicon glyphicon-user" class="men"> </i>Login</a></li>
...
<div class="header" style="background-color: yellow">
	<div class="header-top">
			...
			<div class="container">			
				<div class="logo">
					<h1><a href="index.html">Eye-<span>wear</span></a></h1>
				</div>
		 <!---->
		 
			<div class="top-nav">
				<ul class="memenu skyblue"><li class="active"><a href="logout">Logout</a></li>
					...
					<li class="grid"><a href="addItem">Add Item</a>
						
					</li>
					<li class="grid"><a href="View Products">View Items</a>
...
<!---->
		...
		<div class="sap_tabs">
			...
			<h2>Add Items</h2>
			<center><h1 style="color: red">${info}</h1></center>
			<div style="background-color: #e0e0d1;">
<form:form action="storeItem" commandName="item" method="post" enctype="multipart/form-data">
<center><table>
<tr><td><hr></hr></td></tr>
<tr>
<td style="font-size: 20px">Item Name:</td>

<td><form:input path="itemName" placeholder="Item Name"  style="width:300px;height:40px"/></td>
      <td><form:errors path="itemName"> </form:errors></td>

</tr>
<tr><td><br></br></td></tr>
<tr>
<td style="font-size: 20px">Item Category:</td>
<td><form:select path="category" style="width:300px;height:40px">
...
<tr><td><br></br></td></tr>
<tr>
<td style="font-size: 20px">For:</td>
<td><form:select path="gender"  style="width:300px;height:40px">
...
<tr><td><br></br></td></tr>
<tr>
<td style="font-size: 20px">Item price:</td><td><form:input path="itemPrice" placeholder="Item Price"  required="true" style="width:300px;height:40px"/></td>
</tr>
<tr><td><br></br></td></tr>
<tr>
<td style="font-size: 20px">Item Description:</td><td><form:textarea path="itemDescription" cols="10" rows="10" placeholder="Item Description"   style="width:300px;height:40px"/></td>
<td><form:errors path="itemDescription"></form:errors></td> 
</tr>
<tr><td><br></br></td></tr>
<tr>
...
<tr><td><br></br></td></tr>
<tr>
<td style="font-size: 20px"><td><input type="submit" value="Add New Item"/></td>
</tr>
</table>
</form:form>
</div>
