...
-->
<!DOCTYPE html>
<%@page import="com.ekart.model.Item"%>
...
<!---->
		...
		<div class="sap_tabs">
			...
			<h2>All Items</h2>
										...
										<%session.setAttribute("cart", new Item()); %>
					<hr></hr>
					<div class="container">
...
Enter Product Name:  <input type="text"  ng-model="search">&nbsp&nbsp<span class="glyphicon glyphicon-search"></span>
    ...
    <th>Item Image</th>
        ...
        <tr ng-repeat="resource in names | filter:search">
            ...
            <td><img src="resources/images/{{resource.itemId}}.jpg" style="width: 200px;height:150px"></td>
            <td><a href="viewDetails?id={{resource.itemId}}">View Details</a></td>
