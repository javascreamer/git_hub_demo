...
<div class="container">
  <div>
<form action="editedItem" method="post">
    <hr></hr>
   ...
   <th>Item Name</th>
    ...
    <th>Item Description</th>
        ...
        <td><input type="hidden" value="${item.itemId}" name="itemId"/></td>
            ...
            <td><input type="text" value="${ item.category}" name="category"/></td>
            <td><input type="text" value="${item.itemPrice}" name="itemPrice">/</td>
            <td><input type="text" value="${item.itemDescription}" name="itemDescription"/></td>
