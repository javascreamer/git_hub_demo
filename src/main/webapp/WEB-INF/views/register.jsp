...
<center><h1>${message}</h1></center>
		...
		<h3>PERSONAL INFORMATION</h3>
		  	  <form:form action="addCustomer" commandName="user"> 
					<div class="mation">
					<div>
					...
					<div>
					 ...
					 <div>
						 ...
						 <form:input path="emailAddress"/><form:errors path="emailAddress" style="color:red;"></form:errors>
						 </div>
						 <div>
							<span>Password</span>
								<form:password  path="Password" style="width:800px;height:40px;border:1px solid black"/>	<form:errors path="Password" style="color:red;"></form:errors>					 
					</div>
					 </div>
